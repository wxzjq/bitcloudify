module.exports = {
  // App Info
  appstore_link: "https://bitcloudify.com",                                  // Enter App Store URL.
  playstore_link: "https://bitcloudify.com",                                  // Enter Google Play Store URL.
  google_analytics_ID: "UA-47311644-6",                                        // Enter Google Analytics ID or ""
  presskit_download_link: "https://bitcloudify.com",                                  // Enter a link to downloadable file or (e.g. public Dropbox link to a .zip file). 
  video_or_screenshot: "screenshot",                                           // "screenshot" or "video"
  app_url: "https://agalp.bitcloudify.com",                            // Domain of your website without path_prefix.
  path_prefix: "/",                                                    // Prefixes all links. For cases when deployed to example.github.io/automatic-gatsbyjs-app-landing-page/.
  app_name: "BitCloudify",
  app_price: "Free",
  ...
  // Personal Info
  your_name: "Imed Adel",
  your_link: "https://bitcloudify.com",
  your_city: "Sousse",
  email_address: "hello@bitcloudify.com",
